      ...
      <div class="content">
         <div class="movie_top">
             <div class="col-md-9 movie_box">
                <div class="grid images_3_of_2">
                  ...
                  <div class="movie_rate">
                      <div class="rating_desc"><p>Your Vote :</p>
                      </div>
                ...
                <div class="desc1 span_3_of_2">
                  ...
                  <p class="movie_option"><strong>Country: </strong><a href="single/{{$movie->id}}">established</a>, <a href="single/{{$movie->id}}">{{$movie->country}}</a></p>

                  <p class="movie_option"><strong>Year: </strong>2014</p>

                  <p class="movie_option">
                      <strong>Category: </strong>
                      <a href="single/{{$movie->id}}">{{$movie->category}}</a>,
                       <a href="single/{{$movie->id}}">Fantazy</a>
                  </p>

                  <p class="movie_option"><strong>Release date: </strong>December 12, 2014</p>

                  <p class="movie_option"><strong>Director: </strong><a href="single/{{$movie->id}}">{{$movie->director}} </a></p>

                  <p class="movie_option">
                    <strong>Actors: </strong>
                    <a href="single/{{$movie->id}}">anything</a>,
                     <a href="single/{{$movie->id}}">Lorem Ipsum</a>, 
                     <a href="single/{{$movie->id}}"> discovered</a>, 
                     <a href="single/{{$movie->id}}"> Virginia</a>, 
                     <a href="single/{{$movie->id}}"> Virginia</a>, 
                     <a href="single/{{$movie->id}}">variations</a>, 
                     <a href="single/{{$movie->id}}">variations</a>, 
                     <a href="single/{{$movie->id}}">variations</a>, 
                     <a href="single/{{$movie->id}}"> Virginia</a> 
                     <a href="single/{{$movie->id}}">...</a>
                   </p>
                    <p class="movie_option">
                      <strong>Age restriction: </strong>13
                    </p> 
                    <div class="down_btn">
                      <a class="btn1" href="/movie-files/{{$movie->video_file}}">
                        <span> </span>Download
                      </a>
                    </div>
                 </div>
                      ...
                      <li>
                          <div class="preview">
                            <a href="single/{{$movie->id}}">
                              <img src="/movie-posters/{{$movie->poster}}" class="img-responsive" alt="{{$movie->id}}">
                            </a>
                          </div>
                          <div class="data">
            ...
            <div class="col-md-3">
              <div class="movie_img">
                <div class="grid_2">
                    <img src="/movie-posters/{{$movie->poster}}" class="img-responsive" alt="">
                    <div class="caption1">
